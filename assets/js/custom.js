...
if ($(".single-vertical-carousel").length) {
  $(".single-vertical-carousel").slick({
    ...
    slidesToScroll: 1,
    prevArrow:
      "<div class='prev-btn'><span class='icon-top prev-icon'></span></div>",
    nextArrow:
      "<div class='next-btn'><span class='icon-top next-icon'></span></div>",
  });
}
...
if ($(".course-details__tab-box").length) {
  $(".course-details__tab-box .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(
          ".course-details__tab-box .tabs-button-box .tab-btn-item"
        ).removeClass("active-btn-item");
        $(this).addClass("active-btn-item");
        $(
          ".course-details__tab-box .tabs-content-box .tab-content-box-item"
...
if ($(".academy-statements-area").length) {
  $(".academy-statements-area .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(
          ".academy-statements-area .tabs-button-box .tab-btn-item"
        ).removeClass("active-btn-item");
        $(this).addClass("active-btn-item");
        $(
          ".academy-statements-area .tabs-content-box .tab-content-box-item"
        ).removeClass("tab-content-box-item-active");
        $(target).addClass("tab-content-box-item-active");
      }
    }
...
if ($(".programmes-offered-area").length) {
  $(".programmes-offered-area .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(
          ".programmes-offered-area .tabs-button-box .tab-btn-item"
        ).removeClass("active-btn-item");
        $(this).addClass("active-btn-item");
        $(
          ".programmes-offered-area .tabs-content-box .tab-content-box-item"
        ).removeClass("tab-content-box-item-active");
        $(target).addClass("tab-content-box-item-active");
      }
    }
...
if ($(".program-details-area").length) {
  $(".program-details-area .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".program-details-area .tabs-button-box .tab-btn-item").removeClass(
          "active-btn-item"
        );
        $(this).addClass("active-btn-item");
        $(
          ".program-details-area .tabs-content-box .tab-content-box-item"
        ).removeClass("tab-content-box-item-active");
        $(target).addClass("tab-content-box-item-active");
      }
    }
...
if ($(".involment-activities-area").length) {
  $(".involment-activities-area .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(
          ".involment-activities-area .tabs-button-box .tab-btn-item"
        ).removeClass("active-btn-item");
        $(this).addClass("active-btn-item");
        $(
          ".involment-activities-area .tabs-content-box .tab-content-box-item"
        ).removeClass("tab-content-box-item-active");
        $(target).addClass("tab-content-box-item-active");
      }
    }
...
if ($(".faq-page-one").length) {
  $(".faq-page-one .tabs-button-box .tab-btn-item").on("click", function (e) {
    ...
    if ($(target).hasClass("actve-tab")) {
      ...
      $(".faq-page-one .tabs-button-box .tab-btn-item").removeClass(
        "active-btn-item"
      );
      $(this).addClass("active-btn-item");
      $(".faq-page-one .tabs-content-box .tab-content-box-item").removeClass(
...
if ($(".statements-style2-area").length) {
  $(".statements-style2-area .tabs-button-box .tab-btn-item").on(
    "click",
    function (e) {
      e.preventDefault();
      var target = $($(this).attr("data-tab"));
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".statements-style2-area .tabs-button-box .tab-btn-item").removeClass(
          "active-btn-item"
        );
        $(this).addClass("active-btn-item");
        $(
          ".statements-style2-area .tabs-content-box .tab-content-box-item"
        ).removeClass("tab-content-box-item-active");
        $(target).addClass("tab-content-box-item-active");
      }
    }
